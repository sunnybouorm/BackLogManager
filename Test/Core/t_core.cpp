...
//
//			row.begin()->column_name = "Name";
//			row.begin()->column_data = activity_name;
//
...
//					row.begin()->column_name = "ActivityID";
//					row.begin()->column_data = activity_id;
...
//			row.begin()->column_name = "Name";
//			row.begin()->column_data = activity_name1;
//			creation_is_success = core.AddActivity(row);
//
//			std::string activity_name2 = "Music";
//			row.begin()->column_name = "Name";
//			row.begin()->column_data = activity_name2;
//			creation_is_success &= core.AddActivity(row);
//
//			std::string activity_name3 = "Movies";
//			row.begin()->column_name = "Name";
//			row.begin()->column_data = activity_name3;
//			creation_is_success &= core.AddActivity(row);
//
//			//generate expected result as a basis of comparison
//			//-------------------------------------------------
...
//
//					row.begin()->column_name = "ActivityID";
//					row.begin()->column_name = activity_id_1;
//					deletion_is_success  = core.DeleteActivity(row);
//					row.begin()->column_name = activity_id_2;
//					deletion_is_success &= core.DeleteActivity(row);
//					row.begin()->column_name = activity_id_3;
//					deletion_is_success &= core.DeleteActivity(row);
//
//					core.database_.SqlCommand("SELECT Name FROM Activity\n");
//					TableResult result = core.database_.read_result_buffer();
...
//					row.clear();
//					row.begin()->column_name = "LID";
//					row.begin()->column_data = lid;
